...
input inc;
input dec;
output [$clog2(`PERIOD_VAL)-1:0] pwm_ref;
...
`define DEBOUNCE_TIME (500/80)-1  // Adjust this value based on clock frequency, this was scaled for simulation
...
`define CLK_PWM 10000
`define PERIOD_VAL  `CLK_FREQ/`CLK_PWM
`define N_FILL $clog2(`PERIOD_VAL)-8
